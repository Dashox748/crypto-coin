...
import {signInWithFacebook, signInWithGithub, signInWithGoogle, logInWithEmailAndPassword} from "../../firebase";
...
const LoginForm = () => {
    ...
    const [loginForm, setLoginForm] = useState<LoginFormTypes>({} as LoginFormTypes)
    const [errors, setErrors] = useState<LoginFormErrorTypes>({} as LoginFormErrorTypes)
                    ...
                    <form style={{display: "flex", flexDirection: "column", gap: "15px"}}
                        ...
                        {!errors.valid ?
                            <Typography variant="subtitle1" sx={{margin: "0 auto", color: "gray"}}>Or use Social
                                Network</Typography> :
                            <Typography variant="subtitle1" sx={{margin: "0 auto", color: "#d32f2f"}}>Password Or Email
                                is wrong</Typography>}
                    </form>
