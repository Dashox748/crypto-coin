  ...
  return (
    ...
    >
      ...
      <h1
        ...
        style={{ fontSize: "50px", color: darkTheme ? "white" : null }}
      >
        OOPS WE COULDNT FIND THE PAGE
      </h1>
      <p
        className="mx-auto fs-5 text-muted text-center"
        style={{ maxWidth: "550px" }}
      >
        We couldn't fint the page you were looking for, or maybe it never
        existed, Try heading back to the home page.
      </p>
      <Link to="/" className="text-decoration-none mx-auto">
        <button className="mx-auto bg-primary border-0 px-4 py-2 rounded-3 text-white">
          BACK HOME
        </button>
      </Link>
    </div>
