          ...
          <CDBSidebarContent className="sidebar-content d-flex">
            <CDBSidebarMenu className=" flex-fill">
              <NavLink to="Currencies/ListOfAll">
                <CDBSidebarMenuItem
                  className={darkTheme ? "sidebar-item-hover" : "szmata"}
                  icon="clipboard-list"
              ...
              <CDBSidebarMenuItem
                ...
                className={
                  darkTheme
                    ? "sidebar-item-hover user-select-none"
                    : "szmata user-select-none"
                }
                icon="fire"
                suffix={
                  !showPopular ? (
                  ...
                  ? popular.map((data, index) => (
                      ...
                      >
                        <div
                          ...
                          className={
                            darkTheme
                              ? "d-flex align-items-center justify-content-center sidebar-item-hover py-2 flex-fill fw-normal"
                              : "d-flex align-items-center justify-content-center szmata py-2 flex-fill fw-normal"
                          }
                        >
                          <img
                            src={data.image}
              ...
              <CDBSidebarMenuItem
                ...
                className={
                  darkTheme
                    ? "user-select-none sidebar-item-hover"
                    : "user-select-none szmata"
                }
              >
                Favourites
              </CDBSidebarMenuItem>
                  ...
                  ? favourite.slice(0, 4).map((currency, index) => (
                      ...
                      >
                        <div
                          ...
                          className={
                            darkTheme
                              ? "d-flex align-items-center justify-content-center sidebar-item-hover py-2 flex-fill"
                              : "d-flex align-items-center justify-content-center szmata py-2 flex-fill"
                          }
                        >
                          <img
                            src={`${currency.image}`}
                ...
                {favourite.length > 3 ? (
                  <NavLink to="Currencies/Favourites">
                    <div
                      ...
                      className={
                        darkTheme
                          ? "d-flex align-items-center sidebar-item-hover justify-content-center p-1 mb-3"
                          : "d-flex align-items-center szmata justify-content-center p-1 mb-3"
                      }
                    >
